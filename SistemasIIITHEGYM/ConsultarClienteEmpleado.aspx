                                ...
                                <div class="box-body" style="height: 591px">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10" style="left: 0px; top: 0px; width: 253px">
                                            <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" Enabled="False" Height="24px" Width="128px"></asp:TextBox>
                    ...
                    <br />
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10" style="left: 0px; top: 0px; width: 258px">
                                            <asp:TextBox ID="tbapellido" runat="server" CssClass="form-control" Enabled="False" Height="24px" Width="128px"></asp:TextBox>
                ...
                <%--<div class="form-group">
                  <label for="exampleInputPassword1">Fecha de Nacimiento:</label><asp:TextBox type="date" CssClass="form-control" ID="tbfechanacimiento"  runat="server" Height="24px" Width="128px"></asp:TextBox>
                       ...
                       <br />
                                        ...
                                        <div class="col-sm-10" style="left: 0px; top: 0px; width: 258px">
                                            <asp:TextBox ID="tbfechadenacimiento" runat="server" CssClass="form-control" Enabled="False" Height="24px" TextMode="DateTime" Width="128px"></asp:TextBox>
                   ...
                   <br />
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10" style="left: 0px; top: 0px; width: 258px">
                                            <asp:DropDownList ID="ddltipodedocumento" runat="server" CssClass="form-control" Enabled="False" Height="24px" Width="128px">
                                            </asp:DropDownList>
                  ...
                  <br />
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10" style="left: 0px; top: 0px; width: 257px">
                                            <asp:TextBox ID="tbnumerodocumento" runat="server" CssClass="form-control" Enabled="False" Height="24px" TextMode="number" Width="128px"></asp:TextBox>
            ...
            <!-- form start -->
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        Localidad:</label>
                                        <div class="col-sm-10" style="left: 0px; top: 0px; width: 258px">
                                            <asp:DropDownList ID="ddllocalidad" runat="server" CssClass="form-control" Enabled="False" Height="24px" Width="128px">
                                            </asp:DropDownList>
                   ...
                   <br />
                                    <div class="form-group">
                                        ...
                                        Calle:</label>
                                        <div class="col-sm-10" style="left: 0px; top: 0px; width: 257px">
                                            <asp:TextBox ID="tbcalle" runat="server" CssClass="form-control" Enabled="False" Height="24px" TextMode="number" Width="128px"></asp:TextBox>
                   ...
                   <br />
                                    <div class="form-group">
                                        ...
                                        Barrio:</label>
                                        <div class="col-sm-10" style="left: 0px; top: 0px; width: 257px">
                                            <asp:TextBox ID="tbbarrio" runat="server" CssClass="form-control" Enabled="False" Height="24px" TextMode="number" Width="128px"></asp:TextBox>
            ...
            <!-- /.box-header -->
                    ...
                    <br />
                                    <div class="form-group" style="margin-bottom: 5px">
                                        ...
                                        Contraseña</label>
                                        <div class="col-sm-10">
                                            <asp:TextBox ID="tbcontraseña" runat="server" CssClass="form-control" Enabled="False" Height="24px" TextMode="password" Width="128px"></asp:TextBox>
