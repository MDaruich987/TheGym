          ...
          <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10" style="left: 0px; top: 0px; width: 253px">
                       <asp:DropDownList  CssClass="form-control"   ID="ddlcliente"  runat="server" Height="32px" Width="156px"></asp:DropDownList>
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="ddlcliente" Display="None" ErrorMessage="Seleccione un cliente" SetFocusOnError="True"></asp:RequiredFieldValidator>
