...
namespace SistemasIIITHEGYM
{
    public partial class RegistrarCobroPlanEmpleado : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (dt.Rows.Count < 1)
                {
                    ...
                    if (dt1.Rows.Count > 0)
                    {
                        ...
                        k.AddCuota();
                        NomCliente = tbcliente.Text;
                        nomMonto = tbmonto.Text;
                        nomPlan = ddlplan.SelectedItem.ToString();
        ...
        protected void btngenerarcomprobante_Click1(object sender, EventArgs e)
        {
            
            GenerarPDF(NomCliente, nomMonto, nomPlan);
        }
    }
}