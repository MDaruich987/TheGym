...
<%--                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
   ...
   <asp:Label ID="lblseleccione" runat="server" Text="Seleccione el cliente al cual desea enviar el Email:" Font-Names="Arial" Font-Size="Medium"></asp:Label>       
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MiConec %>" DeleteCommand="DELETE FROM [Cliente] WHERE [Id_cliente] = @Id_cliente" InsertCommand="INSERT INTO [Cliente] ([Nombre], [Apellido], [Fecha_nac], [Email], [Telefono], [Foto], [Estado], [FK_TipoDocumento], [Numero], [Calle], [Barrio], [DNI], [FK_localidad]) VALUES (@Nombre, @Apellido, @Fecha_nac, @Email, @Telefono, @Foto, @Estado, @FK_TipoDocumento, @Numero, @Calle, @Barrio, @DNI, @FK_localidad)" ProviderName="<%$ ConnectionStrings:MiConec.ProviderName %>" SelectCommand="select Nombre,Apellido,DNI,Foto,Email,Vencimiento
