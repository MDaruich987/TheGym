            ...
            <%--fin de contenedor busqueda inicio contenedor gridview--%>
              ...
              <!-- Date -->
                  ...
                  <br />
                                          ...
                                          <asp:GridView ID="gridempleados" runat="server" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" CaptionAlign="Bottom" CellPadding="3" CellSpacing="1" Font-Size="Medium" ForeColor="Black" GridLines="Horizontal" Height="210px" HorizontalAlign="Justify" OnSelectedIndexChanged="gridempleados_SelectedIndexChanged" PageSize="4" ShowHeaderWhenEmpty="True" style="margin-left: 85px; margin-bottom: 9px;" Width="601px" OnRowDeleting="gridempleados_RowDeleting" AllowPaging="True" OnPageIndexChanging="gridempleados_PageIndexChanging">
                                              <Columns>
